...
* [fcrackzip](https://github.com/hyc/fcrackzip) realiza fuerza bruta para adivinar la contraseña de un archivo ZIP (para contraseñas de menos de 7 caracteres aproximadamente).
