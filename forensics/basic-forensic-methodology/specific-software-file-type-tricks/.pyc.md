...
```
**Python exe バイナリ**にコンパイルされた場合、次のようにして **.pyc** を取得できます：
```bash
...
'550d0d0a'
```
**Python3.8**の場合の**マジックナンバー**は**`0x550d0d0a`**です。したがって、このエラーを修正するには、**.pycファイル**の**先頭**に次のバイトを**追加**する必要があります：`0x0d550a0d000000000000000000000000`
