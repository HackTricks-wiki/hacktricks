...
Así es como se verá un **encabezado mágico .pyc python3.8** correctamente añadido:
```bash
...
Consulta la documentación de errores previa.
...
Para comenzar, vamos a mostrar cómo los payloads pueden ser compilados en py2exe y PyInstaller.
