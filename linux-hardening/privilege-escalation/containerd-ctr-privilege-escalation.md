...
Acesse o seguinte link para aprender **o que é o containerd** e o `ctr`:
...
```
Então você pode usar algumas das técnicas mencionadas na seguinte página para **escapar dela abusando das capacidades privilegiadas**:
