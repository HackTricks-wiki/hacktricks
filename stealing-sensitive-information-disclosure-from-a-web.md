...
もしもある時点で、**セッションに基づいて機密情報を表示するウェブページ**を見つけた場合：おそらくクッキーを反映しているか、または印刷しているか、クレジットカードの詳細情報や他の機密情報を表示しているかもしれません。それを盗むことを試みることができます。\
ここでは、それを達成するための主な方法を紹介します：

* [**CORSバイパス**](pentesting-web/cors-bypass.md)：CORSヘッダーをバイパスできれば、悪意のあるページに対してAjaxリクエストを実行して情報を盗むことができます。
* [**XSS**](pentesting-web/xss-cross-site-scripting/)：ページでXSSの脆弱性を見つけた場合、それを悪用して情報を盗むことができるかもしれません。
...
* [**Clickjaking**](pentesting-web/clickjacking.md)：この攻撃に対する保護がない場合、ユーザーをだまして機密データを送らせることができるかもしれません（例は[こちら](https://medium.com/bugbountywriteup/apache-example-servlet-leads-to-61a2720cac20)）。
