...
- [ ] Kry **OS inligting**
- [ ] Kontroleer die [**PATH**](privilege-escalation/index.html#path), is daar 'n **skryfbare gids**?
- [ ] Kontroleer die [**env variables**](privilege-escalation/index.html#env-info), enige sensitiewe besonderhede?
- [ ] Soek na [**kernel exploits**](privilege-escalation/index.html#kernel-exploits) **met behulp van scripts** (DirtyCow?)
- [ ] Kontroleer of die [**sudo version** is vulnerable](privilege-escalation/index.html#sudo-version)
...
- [ ] **Kontroleer vir**[ **useful software**](privilege-escalation/index.html#useful-software) **geïnstalleer**
- [ ] **Kontroleer vir** [**vulnerable software**](privilege-escalation/index.html#vulnerable-software-installed) **geïnstalleer**
...
- [ ] Word 'n [**modifiable script** ](privilege-escalation/index.html#cron-script-overwriting-and-symlink) uitgevoer of is dit in 'n **modifiseerbare gids**?
- [ ] Het jy opgemerk dat 'n **script** moontlik of werklik [**executed** very **frequently**](privilege-escalation/index.html#frequent-cron-jobs)? (elke 1, 2 of 5 minute)
...
- [ ] Kan jy netwerkverkeer **snuffel** met `tcpdump`?
...
- [ ] Kan jy [**escalate privileges thanks to a group**](privilege-escalation/interesting-groups-linux-pe/index.html) waaraan jy behoort?
- [ ] **Clipboard**-data?
- [ ] Wagwoordbeleid?
...
- [ ] Kan jy enige opdrag met **sudo** uitvoer? Kan jy dit gebruik om IETS as root TE LEES, TE SKRYF of UIT TE VOER? ([**GTFOBins**](https://gtfobins.github.io))
- [ ] As `sudo -l` `sudoedit` toelaat, kontroleer vir **sudoedit argument injection** (CVE-2023-22809) via `SUDO_EDITOR`/`VISUAL`/`EDITOR` om willekeurige lêers te wysig op kwesbare weergawes (`sudo -V` < 1.9.12p2). Voorbeeld: `SUDO_EDITOR="vim -- /etc/sudoers" sudoedit /etc/hosts`
