...
Credenciais recuperadas do Logstash comumente desbloqueiam **Elasticsearch**, so check [this other page about Elasticsearch](../../network-services-pentesting/9200-pentesting-elasticsearch.md).
