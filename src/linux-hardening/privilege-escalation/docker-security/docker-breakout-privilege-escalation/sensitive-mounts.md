...
- Contiene il percorso del caricatore di moduli del kernel, invocato per caricare i moduli del kernel.
...
/run/buildkit/buildkitd.sock        # daemon di BuildKit (con privilegi)  
