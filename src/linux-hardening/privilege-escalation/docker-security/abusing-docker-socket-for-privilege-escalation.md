...
Ayrıca konteyner içinde **yetki yükseltmek için bir mount istismar edebilirsiniz**.
...
- **`--privileged`** -> Bu bayrak ile [konteynerden tüm izolasyonu kaldırırsınız](docker-privileged.md#what-affects). [Root olarak ayrıcalıklı konteynerlerden kaçış tekniklerini](docker-breakout-privilege-escalation/#automatic-enumeration-and-escape) kontrol edin.
