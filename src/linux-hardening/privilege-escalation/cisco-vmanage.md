...
```
Erinnern Sie sich an unsere Neo4j-Instanz? Sie läuft unter den Rechten des Benutzers `vmanage`, was es uns ermöglicht, die Datei über die vorherige Schwachstelle abzurufen:
```
