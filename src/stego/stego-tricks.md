...
आप जिस फाइल से निपट रहे हैं, उसकी प्रकार की पहचान करें।
...
वेब-आधारित निकासी के लिए, [इस वेबसाइट](https://futureboy.us/stegano/decinput.html) पर जाएं।
...
Deepsound ध्वनि फ़ाइलों के भीतर जानकारी के एन्क्रिप्शन और पहचान की अनुमति देता है, जिसका उपयोग AES-256 किया जाता है। इसे [आधिकारिक पृष्ठ](http://jpinsoft.net/deepsound/download.aspx) से डाउनलोड किया जा सकता है।
...
ऑडियो फ़ाइलों में DTMF टोन का पता लगाने के लिए ऑनलाइन उपकरणों का उपयोग किया जा सकता है जैसे कि [यह DTMF डिटेक्टर](https://unframework.github.io/dtmf-detect/) और [DialABC](http://dialabc.com/sound/detect/index.html)।
