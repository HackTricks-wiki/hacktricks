...
&#xNAN;_(Varsayılan `[UNK]` ID'sinin `987` olduğu kabul edilirse)_
...
- En sık karşılaşılan token çiftlerini tek bir token haline getirerek iteratif olarak birleştirir.
...
- _Örnek:_\
`"mutsuzluk"` token olarak `["mut", "suz", "luk"]` veya `["mut", "suzluk"]` şeklinde ayrılabilir, bu kelime dağarcığına bağlıdır.
...
- Genellikle daha verimli ve kompakt tokenizasyonlar sağlar.
- _Örnek:_\
