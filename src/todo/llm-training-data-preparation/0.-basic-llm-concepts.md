...
- **Parametri**: Parametri su **učljive težine i pristrasnosti** u neuronskoj mreži. Ovo su brojevi koje proces obuke prilagođava kako bi minimizirao funkciju gubitka i poboljšao performanse modela na zadatku. LLM-ovi obično koriste milione parametara.
...
[[5, 6], [7, 8]]])
```
### Tensor Tipovi Podataka

PyTorch tenzori mogu čuvati podatke različitih tipova, kao što su celobrojni i brojevi sa pomičnom tačkom.&#x20;
...
- **Pristup Obliku**: Koristite `.shape` da dobijete dimenzije tenzora.
