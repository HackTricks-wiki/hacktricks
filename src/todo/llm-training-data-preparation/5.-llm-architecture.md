...
- **Composición de Capas:** Combina atención de múltiples cabezas, red de alimentación, normalización de capas y conexiones residuales.
- **Normalización de Capas:** Aplicada antes de las capas de atención y de alimentación para un entrenamiento estable.
...
- **Dropout:** Aplicado después de las capas de atención y de alimentación para regularización.
...
- **Red de Alimentación (`ff`):** Aplica la transformación de alimentación.
