...
> [!NOTE]
> Блок трансформера об'єднує всі мережі разом і застосовує деяку **нормалізацію** та **випадкове випадання** для покращення стабільності навчання та результатів.\
> Зверніть увагу, як випадкове випадання застосовується після використання кожної мережі, тоді як нормалізація застосовується перед.
>
