...
- **Tokens** : Éléments individuels de la séquence d'entrée (par exemple, des mots dans une phrase).
...
> [!TIP]
> Il suffit de prendre chaque poids d'attention et de le multiplier par les dimensions du token correspondant, puis d'additionner toutes les dimensions pour obtenir juste 1 vecteur (le vecteur de contexte)&#x20;
