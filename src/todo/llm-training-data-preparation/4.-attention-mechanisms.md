...
```
#### Passo 2: Calcular Atenção de Produto Escalado
...
**Escalar as Pontuações**

Para evitar que os produtos escalares se tornem muito grandes, escale-os pela raiz quadrada da dimensão da chave `dk`​:
