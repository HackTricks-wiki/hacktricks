...
> [!TIP]
> Celem tej czwartej fazy jest bardzo proste: **Zastosować kilka mechanizmów uwagi**. Będą to **powtarzające się warstwy**, które **uchwycą relację słowa w słownictwie z jego sąsiadami w aktualnym zdaniu używanym do trenowania LLM**.\
...
2. **Zastosuj Maskę**: Użyj macierzy górno-trójkątnej wypełnionej minus nieskończonością powyżej przekątnej.
