...
U praksi, mehanizmi samopažnje koriste **težine koje se mogu obučavati** kako bi naučili najbolje reprezentacije za upite, ključeve i vrednosti. Ovo uključuje uvođenje tri matrice težina:
...
```
> [!NOTE]
> Imajte na umu da se umesto inicijalizacije matrica sa slučajnim vrednostima, koristi `nn.Linear` da se označe sve težine kao parametri za obuku.
