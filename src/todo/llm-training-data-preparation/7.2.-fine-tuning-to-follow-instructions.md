...
6. **Beyond the Imitation Game Benchmark (**[**BIG-bench**](https://github.com/google/BIG-bench)**):** BIG-bench je velika referentna tačka sa više od 200 zadataka koji testiraju sposobnosti modela u oblastima kao što su rezonovanje, prevođenje i odgovaranje na pitanja.
...
11. [**TriviaQA**](https://nlp.cs.washington.edu/triviaqa/)**:** Veliki skup podataka sa pitanjima i odgovorima iz trivijalnosti, zajedno sa dokumentima kao dokazima.
