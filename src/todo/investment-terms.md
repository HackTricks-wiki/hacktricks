...
* **Futures:** Και οι δύο, ο αγοραστής και ο πωλητής αναλαμβάνουν **απεριόριστο ρίσκο** επειδή είναι υποχρεωμένοι να ολοκληρώσουν το συμβόλαιο. Ο κίνδυνος είναι η διαφορά μεταξύ της συμφωνημένης τιμής και της τιμής της αγοράς κατά την ημερομηνία λήξης.
...
* **Options:** Ο αγοραστής πρέπει να πληρώσει ένα **option premium** προκαταβολικά για το δικαίωμα να ασκήσει την επιλογή. Αυτό το premium είναι ουσιαστικά το κόστος της επιλογής.
