...
Αυτό θα αποτρέψει το να ρυθμιστεί μια μηχανή σε 20ºC να αυξηθεί σε 21ºC με ένα τηλεχειριστήριο, και στη συνέχεια όταν χρησιμοποιηθεί ένα άλλο τηλεχειριστήριο, το οποίο έχει ακόμα τη θερμοκρασία σε 20ºC, να αυξηθεί περισσότερο η θερμοκρασία, θα "αυξηθεί" σε 21ºC (και όχι σε 22ºC νομίζοντας ότι είναι σε 21ºC).
...
* Φυσική ασπίδα ή αφαίρεση IR LEDs σε ευαίσθητες περιοχές
* Παρακολούθηση του κύκλου εργασίας LED της κάμερας και της ακεραιότητας του firmware
...
### Μακροχρόνια Βίαιη Δύναμη & Επεκτεταμένα Πρωτόκολλα με το Flipper Zero 1.0
...
* Παρακολουθήστε την ακεραιότητα του firmware των καμερών/IoT συσκευών που εκθέτουν ελεγχόμενα IR LEDs.
