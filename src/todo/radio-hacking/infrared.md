...
```
* **IRscrutinizer / AnalysIR** – decodificadores GUI que importam capturas brutas e identificam automaticamente o protocolo + geram código Pronto/Arduino.
