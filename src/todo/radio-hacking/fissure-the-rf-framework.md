...
FISSURE'ı geliştirmek için öneriler şiddetle teşvik edilmektedir. Aşağıdakilerle ilgili düşünceleriniz varsa [Tartışmalar](https://github.com/ainfosec/FISSURE/discussions) sayfasında veya Discord Sunucusunda bir yorum bırakın:
