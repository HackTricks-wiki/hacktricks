...
- `s` scansiona per TCK/TMS/TDI/TDO (e a volte TRST/SRST)
...
- Livellamento: preferisci level shifters bidirezionali progettati per segnali push‑pull (le linee JTAG non sono open‑drain). Evita level shifters I2C a direzione automatica per JTAG.
