...
- [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : 8 ferramentas para encontrar subdomínios, sublist3r, amass e mais
...
- [https://crt.sh/?q=%.yahoo.com](https://crt.sh/?q=%.yahoo.com) : Bruteforce de subdomínios
...
- [https://github.com/robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) : Varredura de portas rápida
...
- [https://github.com/TypeError/Bookmarks/blob/master/README.md](https://github.com/TypeError/Bookmarks/blob/master/README.md) : Extensão do Burp para evitar dezenas de abas do Repeater
...
- [https://github.com/Naategh/dom-red](https://github.com/Naategh/dom-red) : Verificar uma lista de domínios contra Open Redirection
...
- [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : Extensão do Chrome para rastrear funções postMessage
- [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Testes automáticos de autenticação (remove cookies e tenta enviar a requisição)
- [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCross é uma ferramenta de Reconstrução, Scanner e para testes de pentesting / BugBounty. Esta ferramenta foi construída para testar vulnerabilidades (XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI)
...
- [https://github.com/odzhan/injection](https://github.com/odzhan/injection) : Técnicas de Process Injection no Windows
- [https://github.com/BankSecurity/Red_Team](https://github.com/BankSecurity/Red_Team) : Scripts para Red Team
- [https://github.com/l0ss/Grouper2](https://github.com/l0ss/Grouper2) : encontrar configurações incorretas relacionadas à segurança no Active Directory Group Policy.
- [https://www.wietzebeukema.nl/blog/powershell-obfuscation-using-securestring](https://www.wietzebeukema.nl/blog/powershell-obfuscation-using-securestring) : Ofuscação SecureString
- [https://pentestlab.blog/2020/02/24/parent-pid-spoofing/](https://pentestlab.blog/2020/02/24/parent-pid-spoofing/) : Spoofing do PID pai
- [https://github.com/the-xentropy/xencrypt](https://github.com/the-xentropy/xencrypt) : Criptografar payloads de PowerShell
...
- [https://windows-internals.com/faxing-your-way-to-system/](https://windows-internals.com/faxing-your-way-to-system/) : Série de artigos sobre Windows Internals
...
Firmware emulation: FIRMADYNE (https://github.com/firmadyne/firmadyne/) é uma plataforma para automatizar a emulação e a análise dinâmica de firmware baseado em Linux.
...
- [https://github.com/skeeto/endlessh](https://github.com/skeeto/endlessh) : SSH tarpit que envia lentamente um banner sem fim.
...
- [https://github.com/rackerlabs/scantron](https://github.com/rackerlabs/scantron) : automatizando varreduras
