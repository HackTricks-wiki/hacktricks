...
- [https://github.com/PaperMtn/lil-pwny](https://github.com/PaperMtn/lil-pwny) : उजागर accounts की जाँच करें
...
- [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : 8 Subdomain finder tools, sublist3r, amass और अन्य
...
- [https://github.com/blark/aiodnsbrute](https://github.com/blark/aiodnsbrute) : domain names को asynchronous रूप से Brute force करना
- [https://crt.sh/?q=%.yahoo.com](https://crt.sh/?q=%.yahoo.com) : Subdomain bruteforce
- [https://github.com/tomnomnom/httprobe](https://github.com/tomnomnom/httprobe): जाँचें कि किसी domain के web servers accessible हैं या नहीं
- [https://github.com/aboul3la/Sublist3r](https://github.com/aboul3la/Sublist3r) : Subdomain discovery
- [https://github.com/gwen001/github-search/blob/master/github-subdomains.py](https://github.com/gwen001/github-search/blob/master/github-subdomains.py) : github में Subdomain discovery
- [https://github.com/robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) : Fast port scanning
- [https://github.com/Threezh1/JSFinder](https://github.com/Threezh1/JSFinder) : web में JS files से Subdomains और URLs
- [https://github.com/C1h2e1/MyFuzzingDict](https://github.com/C1h2e1/MyFuzzingDict) : Web files dictionary
- [https://github.com/TypeError/Bookmarks/blob/master/README.md](https://github.com/TypeError/Bookmarks/blob/master/README.md) : दर्जनों repeater tabs से बचने के लिए BurpExtension
- [https://github.com/hakluke/hakrawler](https://github.com/hakluke/hakrawler) : assets प्राप्त करें
...
- [https://github.com/Naategh/dom-red](https://github.com/Naategh/dom-red) : Open Redirection के विरुद्ध domains की सूची जाँचें
- [https://github.com/prodigysml/Dr.-Watson](https://github.com/prodigysml/Dr.-Watson) : domains, subdomains और IPs खोजने के लिए Burp plugin और offline analysis
- [https://github.com/hahwul/WebHackersWeapons](https://github.com/hahwul/WebHackersWeapons): विभिन्न tools की सूची
- [https://github.com/gauravnarwani97/Trishul](https://github.com/gauravnarwani97/Trishul) : vulns (SQLi, XSS, SSTI) खोजने के लिए BurpSuite Plugin
- [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : post-messages functions को track करने के लिए Chrome extension
- [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Automatic authentication tests (cookies हटाकर request भेजने का प्रयास)
- [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCross Reconstruction, Scanner और penetration / BugBounty testing का tool है। यह tool (XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI) vulnerabilities की जाँच के लिए बनाया गया है
...
- [https://github.com/l0ss/Grouper2](https://github.com/l0ss/Grouper2) : Active Directory Group Policy में security-related misconfigurations खोजें।
...
- [https://github.com/the-xentropy/xencrypt](https://github.com/the-xentropy/xencrypt) : Powershell payloads को Encrypt करें
...
- [https://windows-internals.com/faxing-your-way-to-system/](https://windows-internals.com/faxing-your-way-to-system/) : Windows Internals से संबंधित logs की श्रृंखला
- [https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/](https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/) : document खोलने वाले व्यक्ति को track करें
...
Firmware का analysis करने के लिए उपयोगी लगने वाले tools (automatic):
...
यदि firmware online नहीं मिलता है, तो उसे कैसे extract करें: [https://www.youtube.com/watch?v=Kxvpbu9STU4](https://www.youtube.com/watch?v=Kxvpbu9STU4)

यहाँ vulnerabilities वाला एक firmware है जिसका analysis किया जा सकता है: [https://github.com/scriptingxss/IoTGoat](https://github.com/scriptingxss/IoTGoat)

और यहाँ firmware के analysis के लिए owasp methodology है: [https://github.com/scriptingxss/owasp-fstm](https://github.com/scriptingxss/owasp-fstm)

Firmware emulation: FIRMADYNE (https://github.com/firmadyne/firmadyne/) Linux-based firmware की emulation और dynamic analysis को automate करने का platform है।
...
- [https://github.com/skeeto/endlessh](https://github.com/skeeto/endlessh) : SSH tarpit जो धीरे-धीरे एक endless banner भेजता है।
- AWS और Cloud tools: [https://github.com/toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools)
- phishing के लिए IFS (Interplanetary File System): [https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/using-the-interplanetary-file-system-for-offensive-operations/](https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/using-the-interplanetary-file-system-for-offensive-operations/)
...
- [https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/) : BugBounties शुरू करने के लिए resources
...
- [https://github.com/ElevenPaths/HomePWN](https://github.com/ElevenPaths/HomePWN) : IoT Hacking (Wifi, BLE, SSDP, MDNS)
- [https://github.com/rackerlabs/scantron](https://github.com/rackerlabs/scantron) : scanning को automate करना
- [https://github.com/doyensec/awesome-electronjs-hacking](https://github.com/doyensec/awesome-electronjs-hacking) : यह list Electron.js security से संबंधित topics को cover करती है।
- [https://github.com/serain/bbrecon](https://github.com/serain/bbrecon) : BB programs के बारे में जानकारी
