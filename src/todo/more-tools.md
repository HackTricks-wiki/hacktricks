...
- [https://github.com/PaperMtn/lil-pwny](https://github.com/PaperMtn/lil-pwny) : 漏洩したアカウントを確認
...
- [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : sublist3r、amassなど、8種類のSubdomain finder tools
...
- [https://github.com/blark/aiodnsbrute](https://github.com/blark/aiodnsbrute) : ドメイン名を非同期でBrute force
- [https://crt.sh/?q=%.yahoo.com](https://crt.sh/?q=%.yahoo.com) : Subdomain bruteforce
- [https://github.com/tomnomnom/httprobe](https://github.com/tomnomnom/httprobe): ドメイン内のwebサーバーにアクセスできるか確認
- [https://github.com/aboul3la/Sublist3r](https://github.com/aboul3la/Sublist3r) : Subdomain discovery
- [https://github.com/gwen001/github-search/blob/master/github-subdomains.py](https://github.com/gwen001/github-search/blob/master/github-subdomains.py) : github内でのSubdomain discovery
- [https://github.com/robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) : 高速なport scanning
- [https://github.com/Threezh1/JSFinder](https://github.com/Threezh1/JSFinder) : web内のJSファイルからSubdomainsとURLsを取得
- [https://github.com/C1h2e1/MyFuzzingDict](https://github.com/C1h2e1/MyFuzzingDict) : Web files dictionary
- [https://github.com/TypeError/Bookmarks/blob/master/README.md](https://github.com/TypeError/Bookmarks/blob/master/README.md) : 数十個のrepeater tabsを避けるためのBurpExtension
- [https://github.com/hakluke/hakrawler](https://github.com/hakluke/hakrawler) : assetsを取得
...
- [https://github.com/Naategh/dom-red](https://github.com/Naategh/dom-red) : Open Redirectionに対してドメインのリストを確認
- [https://github.com/prodigysml/Dr.-Watson](https://github.com/prodigysml/Dr.-Watson) : ドメイン、サブドメイン、IPを発見するためのBurp pluginおよびオフライン分析
- [https://github.com/hahwul/WebHackersWeapons](https://github.com/hahwul/WebHackersWeapons): 各種ツールのリスト
- [https://github.com/gauravnarwani97/Trishul](https://github.com/gauravnarwani97/Trishul) : 脆弱性（SQLi、XSS、SSTI）を発見するBurpSuite Pluging
- [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : post-messages functionsを追跡するChrome extension
- [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Automatic authentication tests（cookiesを削除してrequestの送信を試行）
- [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCrossは、Recon​​struction、Scanner、penetration / BugBounty testing用のツールです。このツールは（XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI）vulnerabilitiesのテスト用に構築されています
...
- [https://github.com/l0ss/Grouper2](https://github.com/l0ss/Grouper2) : Active Directory Group Policy内のsecurity-related misconfigurationsを発見
...
- [https://github.com/the-xentropy/xencrypt](https://github.com/the-xentropy/xencrypt) : Powershell payloadsをEncrypt
...
- [https://windows-internals.com/faxing-your-way-to-system/](https://windows-internals.com/faxing-your-way-to-system/) : Windows Internalsに関する一連のlogs
- [https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/](https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/) : ドキュメントを開いたユーザーを追跡
...
Firmwareを分析するのに便利そうなTools（automatic）:
...
オンラインで見つからない場合にFirmwareを抽出する方法: [https://www.youtube.com/watch?v=Kxvpbu9STU4](https://www.youtube.com/watch?v=Kxvpbu9STU4)

脆弱性のあるFirmwareを分析するための例: [https://github.com/scriptingxss/IoTGoat](https://github.com/scriptingxss/IoTGoat)

Firmwareを分析するためのowasp methodologyはこちら: [https://github.com/scriptingxss/owasp-fstm](https://github.com/scriptingxss/owasp-fstm)

Firmware emulation: FIRMADYNE (https://github.com/firmadyne/firmadyne/) は、Linux-based firmwareのemulationおよびdynamic analysisを自動化するためのplatformです。
...
- [https://github.com/skeeto/endlessh](https://github.com/skeeto/endlessh) : ゆっくりと無限のbannerを送信するSSH tarpit
...
- [https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/) : BugBountiesを始めるためのResources
...
- [https://github.com/rackerlabs/scantron](https://github.com/rackerlabs/scantron) : scanningを自動化
- [https://github.com/doyensec/awesome-electronjs-hacking](https://github.com/doyensec/awesome-electronjs-hacking) : このlistはElectron.js security related topicsを扱うことを目的としています。
- [https://github.com/serain/bbrecon](https://github.com/serain/bbrecon) : BB programsに関するInfo
