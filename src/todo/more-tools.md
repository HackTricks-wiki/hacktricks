...
- [https://github.com/PaperMtn/lil-pwny](https://github.com/PaperMtn/lil-pwny) : Açığa çıkmış hesapları kontrol et
...
- [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : 8 Subdomain finder aracı, sublist3r, amass ve daha fazlası
...
- [https://github.com/blark/aiodnsbrute](https://github.com/blark/aiodnsbrute) : Alan adlarını eşzamansız olarak Brute force yapar
- [https://crt.sh/?q=%.yahoo.com](https://crt.sh/?q=%.yahoo.com) : Subdomain bruteforce
- [https://github.com/tomnomnom/httprobe](https://github.com/tomnomnom/httprobe): Bir alan içindeki web sunucularının erişilebilir olup olmadığını kontrol eder
...
- [https://github.com/Threezh1/JSFinder](https://github.com/Threezh1/JSFinder) : Bir web sitesindeki JS dosyalarından alt alan adları ve URL'ler
- [https://github.com/C1h2e1/MyFuzzingDict](https://github.com/C1h2e1/MyFuzzingDict) : Web dosyaları sözlüğü
- [https://github.com/TypeError/Bookmarks/blob/master/README.md](https://github.com/TypeError/Bookmarks/blob/master/README.md) : Onlarca repeater sekmesinden kaçınmak için BurpExtension
- [https://github.com/hakluke/hakrawler](https://github.com/hakluke/hakrawler) : Assets elde etme
- [https://github.com/izo30/google-dorker](https://github.com/izo30/google-dorker) : Google dorks
- [https://github.com/sehno/Bug-bounty/blob/master/bugbounty_checklist.md](https://github.com/sehno/Bug-bounty/blob/master/bugbounty_checklist.md) : Web BugBounty kontrol listesi
- [https://github.com/Naategh/dom-red](https://github.com/Naategh/dom-red) : Bir domain listesini Open Redirection'a karşı kontrol eder
- [https://github.com/prodigysml/Dr.-Watson](https://github.com/prodigysml/Dr.-Watson) : Burp plugin, domain, alt alan ve IP keşfetmek için offline analiz
- [https://github.com/hahwul/WebHackersWeapons](https://github.com/hahwul/WebHackersWeapons): Farklı araçların listesi
- [https://github.com/gauravnarwani97/Trishul](https://github.com/gauravnarwani97/Trishul) : BurpSuite eklentisi zafiyetleri bulmak için (SQLi, XSS, SSTI)
- [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : postMessage fonksiyonlarını izlemek için Chrome uzantısı
- [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Otomatik kimlik doğrulama testleri (çerezleri kaldırıp isteği yeniden gönderir)
- [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCross, yeniden yapılandırma, tarayıcı ve penetration / BugBounty testi için bir araçtır. Bu araç (XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI) zafiyetlerini test etmek için oluşturuldu.
...
- [https://github.com/l0ss/Grouper2](https://github.com/l0ss/Grouper2) : Active Directory Group Policy'de güvenlikle ilgili yanlış yapılandırmaları bulur.
...
- [https://windows-internals.com/faxing-your-way-to-system/](https://windows-internals.com/faxing-your-way-to-system/) : Windows Internals hakkında bir dizi yazı
- [https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/](https://bestestredteam.com/2018/10/02/tracking-pixel-in-microsoft-office-document/) : Bir belgeyi kimin açtığını izleme
...
- [https://github.com/skeeto/endlessh](https://github.com/skeeto/endlessh) : SSH tarpit; yavaşça sonsuz bir banner gönderir.
...
- [https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/) : BugBounty'lere başlamak için kaynaklar
...
- [https://github.com/rackerlabs/scantron](https://github.com/rackerlabs/scantron) : Tarama otomasyonu
- [https://github.com/doyensec/awesome-electronjs-hacking](https://github.com/doyensec/awesome-electronjs-hacking) : Bu liste Electron.js güvenliği ile ilgili konuları kapsamayı amaçlar.
