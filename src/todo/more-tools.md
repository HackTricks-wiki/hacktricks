...
- [https://www.nmmapper.com/sys/tools/subdomainfinder/](https://www.nmmapper.com/sys/tools/subdomainfinder/) : 8개의 Subdomain finder 도구, sublist3r, amass 등
...
- [https://github.com/blark/aiodnsbrute](https://github.com/blark/aiodnsbrute) : 도메인 이름을 비동기 방식으로 Brute force
- [https://crt.sh/?q=%.yahoo.com](https://crt.sh/?q=%.yahoo.com) : Subdomain bruteforce
- [https://github.com/tomnomnom/httprobe](https://github.com/tomnomnom/httprobe): 도메인의 web server에 접근할 수 있는지 확인
- [https://github.com/aboul3la/Sublist3r](https://github.com/aboul3la/Sublist3r) : Subdomain discovery
- [https://github.com/gwen001/github-search/blob/master/github-subdomains.py](https://github.com/gwen001/github-search/blob/master/github-subdomains.py) : github에서 Subdomain discovery
- [https://github.com/robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) : 빠른 port scanning
- [https://github.com/Threezh1/JSFinder](https://github.com/Threezh1/JSFinder) : web의 JS 파일에서 Subdomains 및 URLs 수집
- [https://github.com/C1h2e1/MyFuzzingDict](https://github.com/C1h2e1/MyFuzzingDict) : Web files dictionary
- [https://github.com/TypeError/Bookmarks/blob/master/README.md](https://github.com/TypeError/Bookmarks/blob/master/README.md) : 수십 개의 repeater 탭을 방지하는 BurpExtension
- [https://github.com/hakluke/hakrawler](https://github.com/hakluke/hakrawler) : assets 수집
...
- [https://github.com/Naategh/dom-red](https://github.com/Naategh/dom-red) : Open Redirection에 대해 도메인 목록 확인
- [https://github.com/prodigysml/Dr.-Watson](https://github.com/prodigysml/Dr.-Watson) : domains, subdomains 및 IPs를 찾기 위한 Burp plugin 및 offline analysis
- [https://github.com/hahwul/WebHackersWeapons](https://github.com/hahwul/WebHackersWeapons): 다양한 도구 목록
- [https://github.com/gauravnarwani97/Trishul](https://github.com/gauravnarwani97/Trishul) : 취약점(SQLi, XSS, SSTI)을 찾기 위한 BurpSuite Pluging
- [https://github.com/fransr/postMessage-tracker](https://github.com/fransr/postMessage-tracker) : post-messages functions 추적을 위한 Chrome extension
- [https://github.com/Quitten/Autorize](https://github.com/Quitten/Autorize) : Automatic authentication tests (cookies를 제거하고 request 전송 시도)
- [https://github.com/pikpikcu/xrcross](https://github.com/pikpikcu/xrcross): XRCross는 Reconstruction, Scanner 및 penetration / BugBounty testing 도구입니다. 이 도구는 (XSS|SSRF|CORS|SSTI|IDOR|RCE|LFI|SQLI) 취약점을 테스트하기 위해 제작되었습니다.
...
- [https://github.com/l0ss/Grouper2](https://github.com/l0ss/Grouper2) : Active Directory Group Policy에서 보안 관련 잘못된 설정 찾기
...
- [https://github.com/the-xentropy/xencrypt](https://github.com/the-xentropy/xencrypt) : Powershell payloads 암호화
...
- [https://windows-internals.com/faxing-your-way-to-system/](https://windows-internals.com/faxing-your-way-to-system/) : Windows Internals에 관한 로그 모음
...
온라인에서 찾을 수 없는 경우 firmware 추출 방법: [https://www.youtube.com/watch?v=Kxvpbu9STU4](https://www.youtube.com/watch?v=Kxvpbu9STU4)

분석할 수 있는 취약한 firmware: [https://github.com/scriptingxss/IoTGoat](https://github.com/scriptingxss/IoTGoat)

그리고 firmware 분석을 위한 owasp 방법론: [https://github.com/scriptingxss/owasp-fstm](https://github.com/scriptingxss/owasp-fstm)
...
- [https://github.com/skeeto/endlessh](https://github.com/skeeto/endlessh) : 천천히 무한 banner를 전송하는 SSH tarpit
- AWS 및 Cloud tools: [https://github.com/toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools)
- phising을 위한 IFS(Interplanetary File System): [https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/using-the-interplanetary-file-system-for-offensive-operations/](https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/using-the-interplanetary-file-system-for-offensive-operations/)
...
- [https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters/) : BugBounties를 시작하기 위한 리소스
...
- [https://github.com/rackerlabs/scantron](https://github.com/rackerlabs/scantron) : scanning 자동화
...
- [https://github.com/serain/bbrecon](https://github.com/serain/bbrecon) : BB programs에 관한 정보
