...
- **Προστασία LSA** εισάγεται για να προστατεύσει τη διαδικασία της Τοπικής Αρχής Ασφαλείας (LSA) από μη εξουσιοδοτημένη ανάγνωση μνήμης και έγχυση κώδικα. Αυτό επιτυγχάνεται με την επισήμανση της LSASS ως προστατευμένη διαδικασία. Η ενεργοποίηση της Προστασίας LSA περιλαμβάνει:
...
- `/user`: Το όνομα χρήστη που θα γίνει impersonate.
...
- Εντολή: `kerberos::ptc`
- Εισάγει εισιτήρια Kerberos από αρχεία κρυφής μνήμης.
...
### Παρέμβαση στο Active Directory
