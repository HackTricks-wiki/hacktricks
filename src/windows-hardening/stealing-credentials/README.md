...
Puoi anche utilizzare [SharpDump](https://github.com/GhostPack/SharpDump).
```bash:Dump lsass
#Local
...
```
### Dumpare la cronologia delle password di NTDS.dit dal DC di destinazione
```
...
```
Puoi anche utilizzare il trucco della [**volume shadow copy**](#stealing-sam-and-system) per copiare il file **ntds.dit**. Ricorda che avrai anche bisogno di una copia del file **SYSTEM** (ancora, [**estrailo dal registro o usa il trucco della volume shadow copy**](#stealing-sam-and-system)).
