...
Ελέγξτε ποια αρχεία/επέκταση είναι στη μαύρη/λευκή λίστα:
```powershell
...
Αυτή η μέθοδος απαιτεί τον **θύμα χρήστη** να είναι **ενεργοποιημένος** σε μια **διαδικασία** μέσα στον υπολογιστή. Αν αυτό ισχύει, χρησιμοποιώντας μια συνεδρία `meterpreter` μπορείτε να προσποιηθείτε το διακριτικό της διαδικασίας του χρήστη (`impersonate_token` από `incognito`). Ή μπορείτε απλώς να `migrate` στη διαδικασία του χρήστη.
