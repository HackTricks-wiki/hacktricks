...
| [Gebruikersrekeningbeheer: Gedrag van die verhoogde prompt vir standaard gebruikers](https://docs.microsoft.com/en-us/windows/security/identity-protection/user-account-control/user-account-control-group-policy-and-registry-key-settings#user-account-control-behavior-of-the-elevation-prompt-for-standard-users)                                                                   | ConsentPromptBehaviorUser   | Vra om geloofsbriewe op die veilige lessenaar               |
...
| [Gebruikersrekeningbeheer: Skakel oor na die veilige lessenaar wanneer daar vir verhoogde toegang gevra word](https://docs.microsoft.com/en-us/windows/security/identity-protection/user-account-control/user-account-control-group-policy-and-registry-key-settings#user-account-control-switch-to-the-secure-desktop-when-prompting-for-elevation)                                                       | PromptOnSecureDesktop       | Geaktiveer                                                  |
...
- As **`2`** (**Altijd vra my**) sal UAC altyd bevestiging van die administrateur vra wanneer hy probeer om iets met hoë regte uit te voer (op Secure Desktop)
...
As jy nie omgee om ratelend te wees nie, kan jy altyd **iets soos** [**https://github.com/Chainski/ForceAdmin**](https://github.com/Chainski/ForceAdmin) **hardloop wat vra om toestemmings te verhoog totdat die gebruiker dit aanvaar**.

### Jou eie omseiling - Basiese UAC omseil metodologie
