...
Quindi, per **bypassare** l'**UAC** (elevare da **livello** di integrità **medio** a **alto**) alcuni attaccanti utilizzano questo tipo di binari per **eseguire codice arbitrario** perché verrà eseguito da un **processo di alta integrità**.
...
- Se **`1`** l'amministratore è **richiesto di inserire nome utente e password** per eseguire il binario con diritti elevati (su Secure Desktop)
...
### Il tuo bypass - Metodologia di bypass UAC di base
