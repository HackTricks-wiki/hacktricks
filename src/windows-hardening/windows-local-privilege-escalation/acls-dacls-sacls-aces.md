...
- **System Access Control List (SACL):** यह किसी वस्तु तक पहुँच के प्रयासों के ऑडिटिंग को नियंत्रित करता है।

एक फ़ाइल तक पहुँचने की प्रक्रिया में सिस्टम उपयोगकर्ता के एक्सेस टोकन के खिलाफ वस्तु के सुरक्षा विवरण की जांच करता है ताकि यह निर्धारित किया जा सके कि क्या पहुँच दी जानी चाहिए और उस पहुँच की सीमा, ACEs के आधार पर।

### **Key Components**

- **DACL:** इसमें ACEs होते हैं जो उपयोगकर्ताओं और समूहों को किसी वस्तु के लिए पहुँच अनुमतियाँ प्रदान या अस्वीकृत करते हैं। यह मूल रूप से मुख्य ACL है जो पहुँच अधिकारों को निर्धारित करता है।
- **SACL:** इसका उपयोग वस्तुओं तक पहुँच के ऑडिटिंग के लिए किया जाता है, जहाँ ACEs सुरक्षा इवेंट लॉग में लॉग की जाने वाली पहुँच के प्रकारों को परिभाषित करते हैं। यह अनधिकृत पहुँच प्रयासों का पता लगाने या पहुँच समस्याओं को हल करने के लिए अमूल्य हो सकता है।
...
Local Security Authority (LSASS) वस्तुओं के लिए पहुँच अनुरोधों को संसाधित करता है, DACL में ACEs की जांच करके जो सुरक्षा प्रिंसिपल द्वारा पहुँच के प्रयास से मेल खाते हैं। यदि कोई प्रासंगिक ACE नहीं मिलती है, तो तुरंत पहुँच दी जाती है। अन्यथा, LSASS पहुँच टोकन में सुरक्षा प्रिंसिपल के SID के खिलाफ ACEs की तुलना करता है ताकि पहुँच की पात्रता निर्धारित की जा सके।
...
- **Access Decision:** DACL ACEs की तुलना करके की जाती है; SACLs का उपयोग ऑडिटिंग के लिए किया जाता है।
...
- **System Audit ACE**: यह System Access Control List (SACL) के भीतर स्थित है, यह ACE उपयोगकर्ताओं या समूहों द्वारा किसी वस्तु तक पहुँच के प्रयासों पर ऑडिट लॉग उत्पन्न करने के लिए जिम्मेदार है। यह दस्तावेज करता है कि पहुँच अनुमत थी या अस्वीकृत और पहुँच की प्रकृति क्या थी।
...
पहुँच निर्धारण प्रत्येक ACE की क्रमबद्ध जांच करके किया जाता है जब तक:
...
**ACEs** (नियम जो यह कहते हैं कि कौन कुछ तक पहुँच सकता है या नहीं) को **DACL** में रखने का तरीका बहुत महत्वपूर्ण है। इसका कारण यह है कि एक बार जब सिस्टम इन नियमों के आधार पर पहुँच देता है या अस्वीकृत करता है, तो यह बाकी की जांच करना बंद कर देता है।
...
- जो नियम कहीं और से आते हैं, उन्हें **सबसे निकटतम स्रोत** से शुरू करें, जैसे कि माता-पिता, और फिर पीछे की ओर जाएँ। फिर से, **"नहीं"** को **"हाँ"** से पहले रखें।
...
- यह किसी आइटम के मालिक को यह **अंतिम निर्णय** लेने की अनुमति देता है कि कौन अंदर आता है, इससे पहले कि माता-पिता फ़ोल्डर या आगे के नियम लागू हों।
...
तो, यह **"canonical order"** सभी पहुँच नियमों को स्पष्ट और अच्छी तरह से काम करने के लिए सुनिश्चित करने के बारे में है, विशेष नियमों को पहले रखकर और सब कुछ को एक स्मार्ट तरीके से व्यवस्थित करके।
...
ACEs ACL में व्यक्तिगत नियम होते हैं। वे उपयोगकर्ताओं या समूहों की पहचान करते हैं, यह निर्दिष्ट करते हैं कि कौन सी पहुँच अनुमत या अस्वीकृत है, और यह निर्धारित करते हैं कि ये नियम उप-आइटम (विरासत) पर कैसे लागू होते हैं। ACEs के दो मुख्य प्रकार होते हैं:
...
प्रत्येक ACE में महत्वपूर्ण जानकारी होती है जैसे कि नियम किस पर लागू होता है (एक Security Identifier या SID का उपयोग करके), नियम क्या अनुमति देता है या अस्वीकृत करता है (एक एक्सेस मास्क का उपयोग करके), और यह अन्य वस्तुओं द्वारा कैसे विरासत में लिया जाता है।
...
- **Object-Specific ACEs** अधिक जटिल परिदृश्यों के लिए उपयोग किए जाते हैं, विशेष रूप से Active Directory जैसे वातावरण में, जहाँ आपको किसी वस्तु की विशिष्ट विशेषताओं तक पहुँच को अलग-अलग नियंत्रित करने की आवश्यकता हो सकती है।

संक्षेप में, ACLs और ACEs सटीक पहुँच नियंत्रण को परिभाषित करने में मदद करते हैं, यह सुनिश्चित करते हुए कि केवल सही व्यक्ति या समूह संवेदनशील जानकारी या संसाधनों तक पहुँच प्राप्त करते हैं, और पहुँच अधिकारों को व्यक्तिगत विशेषताओं या वस्तु प्रकारों के स्तर तक अनुकूलित करने की क्षमता होती है।
...
| Access mask | 32-बिट मान जिसका बिट्स वस्तु के लिए पहुँच अधिकारों से मेल खाते हैं। बिट्स को चालू या बंद किया जा सकता है, लेकिन सेटिंग का अर्थ ACE प्रकार पर निर्भर करता है। उदाहरण के लिए, यदि वह बिट जो पढ़ने के अधिकार से मेल खाता है चालू है, और ACE प्रकार Deny है, तो ACE वस्तु के अनुमतियों को पढ़ने के अधिकार को अस्वीकृत करता है। यदि वही बिट चालू है लेकिन ACE प्रकार Allow है, तो ACE वस्तु के अनुमतियों को पढ़ने के अधिकार को प्रदान करता है। एक्सेस मास्क के अधिक विवरण अगले तालिका में दिखाई देते हैं। |
