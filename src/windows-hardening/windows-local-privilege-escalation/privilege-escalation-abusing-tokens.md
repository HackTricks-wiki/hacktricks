...
| **`SeTcb`**                | _**Admin**_ | 3rd party tool          | <p>Manipola i token per includere diritti di amministratore locale. Potrebbe richiedere SeImpersonate.</p><p>Da verificare.</p>                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                                                                                |
