...
- **Hali za Uigaji wa Token:** Uigaji wenye mafanikio unahitaji token lengwa kuwa ya mtumiaji yule yule na kuwa na kiwango cha uaminifu ambacho ni kidogo au sawa na kiwango cha uaminifu cha mchakato unaojaribu kuigiza.
...
whoami /priv
```
Au **script** umejumuishwa katika [**post**](https://www.leeholmes.com/adjusting-token-privileges-in-powershell/).
