...
Zatim, ova privilegija omogućava **dodeljivanje primarnog tokena** novom/obustavljenom procesu. Sa privilegovanim tokenom za impersonaciju možete derivirati primarni token (DuplicateTokenEx).\
...
| **`SeCreateToken`**        | _**Admin**_ | 3rd party tool          | Kreirajte proizvoljni token uključujući lokalne admin privilegije sa `NtCreateToken`.                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                |
...
| **`SeTcb`**                | _**Admin**_ | 3rd party tool          | <p>Manipulišite tokenima da uključite lokalne admin privilegije. Može zahtevati SeImpersonate.</p><p>Treba potvrditi.</p>                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                                                                                |
