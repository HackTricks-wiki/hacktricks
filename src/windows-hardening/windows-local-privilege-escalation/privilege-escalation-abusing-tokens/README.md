...
| **`SeDebug`**              | _**Admin**_  | **PowerShell**          | Duplizieren Sie das Token von `lsass.exe`.                                                                                                                                                                                                                                                                                                        | Skript zu finden bei [FuzzySecurity](https://github.com/FuzzySecurity/PowerShell-Suite/blob/master/Conjure-LSASS.ps1)                                                                                                                                                                                                         |
...
| **`SeTcb`**                | _**Admin**_  | 3rd party tool          | <p>Manipulieren Sie Tokens, um lokale Administratorrechte einzuschließen. Kann SeImpersonate erfordern.</p><p>Zu überprüfen.</p>                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                                                                                |
