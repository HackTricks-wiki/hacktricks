...
Αν **ανήκεις σε κάποια προνομιούχα ομάδα, μπορεί να είσαι σε θέση να εκμεταλλευτείς τα προνόμια**. Μάθε για τις προνομιούχες ομάδες και πώς να τις εκμεταλλευτείς για να εκμεταλλευτείς τα προνόμια εδώ:
...
- **GENERIC_ALL**: Επίσης κληρονομεί την ικανότητα να αλλάξει τις ρυθμίσεις της υπηρεσίας.
...
Αν ο δρόμος προς ένα εκτελέσιμο αρχείο δεν είναι μέσα σε εισαγωγικά, τα Windows θα προσπαθήσουν να εκτελέσουν κάθε τερματισμό πριν από ένα κενό.
...
## Από το Μέσο Επίπεδο Ακεραιότητας του Διαχειριστή στο Υψηλό Επίπεδο Ακεραιότητας / Παράκαμψη UAC
...
## **Από Υψηλό Επίπεδο Ακεραιότητας στο Σύστημα**

### **Νέα υπηρεσία**

Εάν ήδη εκτελείτε μια διαδικασία Υψηλού Επίπεδου Ακεραιότητας, η **μετάβαση στο SYSTEM** μπορεί να είναι εύκολη απλά **δημιουργώντας και εκτελώντας μια νέα υπηρεσία**:
```
...
Αυτή η τεχνική χρησιμοποιείται από το meterpreter για να κλιμακώσει στο `getsystem`. Η τεχνική συνίσταται στο **να δημιουργήσετε έναν σωλήνα και στη συνέχεια να δημιουργήσετε/καταχραστείτε μια υπηρεσία για να γράψετε σε αυτόν τον σωλήνα**. Στη συνέχεια, ο **διακομιστής** που δημιούργησε τον σωλήνα χρησιμοποιώντας το **`SeImpersonate`** προνόμιο θα μπορεί να **υποδυθεί το token** του πελάτη του σωλήνα (της υπηρεσίας) αποκτώντας προνόμια SYSTEM.\
...
**Καλύτερο εργαλείο για αναζήτηση τοπικών διανυσμάτων κλιμάκωσης προνομίων Windows:** [**WinPEAS**](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/winPEAS)
