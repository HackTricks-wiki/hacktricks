...
**Загально відомі** реєстрації AutoRun:
...
> [!NOTE]
> **Експлуатація 2**: Якщо ви можете перезаписати будь-які з бінарних файлів, вказаних в будь-якому з реєстрів всередині **HKLM**, ви можете модифікувати цей бінарний файл з бекдором, коли інший користувач входить в систему, і підвищити привілеї.
```bash
#CMD
...
- **StubPath:** Визначає команду, яка буде виконана Active Setup. Це може бути будь-яка дійсна командна стрічка, наприклад, запуск `notepad`.
