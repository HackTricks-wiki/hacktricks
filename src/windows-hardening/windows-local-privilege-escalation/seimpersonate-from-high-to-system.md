...
Σε ορισμένες περιπτώσεις, μπορεί να προσπαθήσετε να προσποιηθείτε το System και να μην λειτουργήσει, εμφανίζοντας μια έξοδο όπως η παρακάτω:
```cpp
[+] OpenProcess() success!
...
Ας ελέγξουμε τις τρέχουσες άδειες Διαχειριστή πάνω σε διαδικασίες `svchost.exe` με **processes explorer** (ή μπορείτε επίσης να χρησιμοποιήσετε το process hacker):
