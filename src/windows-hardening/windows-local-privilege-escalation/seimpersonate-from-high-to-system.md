...
Попереднє зображення містить усі привілеї, які мають "Адміністратори" над вибраним процесом (як ви можете бачити, у випадку `svchost.exe` вони мають лише привілеї "Запит")

Перегляньте привілеї, які "Адміністратори" мають над `winlogon.exe`:

![](<../../images/image (1102).png>)

У цьому процесі "Адміністратори" можуть "Читати пам'ять" і "Читати дозволи", що, ймовірно, дозволяє адміністраторам імплементувати токен, використаний цим процесом.
