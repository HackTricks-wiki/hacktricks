...
**MoTW** (Mark of The Web) is an [NTFS Alternate Data Stream](<[https://en.wikipedia.org/wiki/NTFS#Alternate_data_stream_(ADS)](https://en.wikipedia.org/wiki/NTFS#Alternate_data_stream_(ADS))>) with the name of Zone.Identifier which is automatically created upon download files from the internet, along with the URL it was downloaded from.
