...
अवधारणाओं के स्तर के बारे में अधिक जानकारी के लिए:
...
कुछ कार्यक्रम **स्वचालित रूप से** **उपयोगकर्ता समूह** में होने पर **autoelevated** होते हैं। इन बाइनरी में उनके _**Manifests**_ के अंदर _**autoElevate**_ विकल्प का मान _**True**_ होता है। बाइनरी को **Microsoft द्वारा हस्ताक्षरित** होना चाहिए।

फिर, **UAC** को **बायपास** करने के लिए (उच्च **integrity** स्तर **से उच्च** पर) कुछ हमलावर इस प्रकार की बाइनरी का उपयोग करते हैं ताकि वे **मनमाने कोड को निष्पादित** कर सकें क्योंकि इसे **उच्च स्तर की अखंडता प्रक्रिया** से निष्पादित किया जाएगा।

आप _**sigcheck.exe**_ उपकरण का उपयोग करके एक बाइनरी का _**Manifest**_ **चेक** कर सकते हैं। और आप _Process Explorer_ या _Process Monitor_ (Sysinternals का) का उपयोग करके प्रक्रियाओं के **integrity level** को **देख** सकते हैं।
