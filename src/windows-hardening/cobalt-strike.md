...
steal_token <pid> #Roube o token do processo criado pelo mimikatz
...
## No cobalt: Listeners > Adicionar e definir o Payload para Foreign HTTP. Defina o Host para 10.10.5.120, a Porta para 8080 e clique em Salvar.
...
- Segurança EID 4624 - Verifique todos os logons interativos para saber os horários usuais de operação.
