...
* **smb बीकन चयनित नाम के साथ एक पिपेनाम में सुनेंगे**। SMB बीकन से कनेक्ट करने के लिए आपको `link [target] [pipe]` कमांड का उपयोग करना होगा।
...
## API दस्तावेज़ से हम जानते हैं कि यह लॉगऑन प्रकार "कॉलर को अपने वर्तमान टोकन को क्लोन करने की अनुमति देता है"। यही कारण है कि बीकन आउटपुट कहता है Impersonated &#x3C;current_username> - यह हमारे अपने क्लोन किए गए टोकन का अनुकरण कर रहा है।
ls \\computer_name\c$ # कंप्यूटर में C$ तक पहुँचने के लिए उत्पन्न टोकन का उपयोग करने का प्रयास करें
...
## WMI के साथ एक बीकन निष्पादित करने के लिए (यह कूद कमांड में नहीं है) बस बीकन अपलोड करें और इसे निष्पादित करें
...
## आप केवल विदेशी लिस्नर के साथ x86 मीटरप्रेटर सत्र उत्पन्न कर सकते हैं।
