...
## Enrollment Agent olarak Süreklilik – PERSIST5

Geçerli bir Sertifika Talep Ajanı/Enrollment Agent sertifikası alırsanız, kullanıcılar adına yeni oturum açma yetkisine sahip sertifikalar oluşturabilir ve ajan PFX'ini çevrimdışı bir süreklilik belirteci olarak saklayabilirsiniz. Kötüye kullanım iş akışı:
```bash
...
- Temsilci talepleri ve olağandışı yenileme desenleri için CA verme günlükleri.
