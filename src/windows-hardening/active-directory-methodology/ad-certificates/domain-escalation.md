...
```
Luego puedes transformar el **certificado a formato `.pfx`** y usarlo para **autenticarte usando Rubeus o certipy** nuevamente:
```bash
...
Si el servidor CA no está configurado con `IF_ENFORCEENCRYPTICERTREQUEST`, puede realizar ataques de relé NTLM sin firma a través del servicio RPC. [Reference in here](https://blog.compass-security.com/2022/11/relaying-to-ad-certificate-services-over-rpc/).
