...
हालांकि, यदि **S4U2Proxy** में उपयोग किया गया **TGS** **Forwardable नहीं है** तो **basic Constrain Delegation** का दुरुपयोग करने की कोशिश करना **काम नहीं करेगा**। लेकिन यदि आप **Resource-Based constrain delegation** का शोषण करने की कोशिश कर रहे हैं, तो यह काम करेगा।
...
1. S4U2Self (समझौता/बनाए गए SPN खाते से): मुझसे **Administrator का TGS मांगें** (Forwardable नहीं)।
...
4. हमलावर **ticket पास कर सकता है** और उपयोगकर्ता का **अनुकरण कर सकता है** ताकि **शिकार ServiceB तक पहुंच प्राप्त कर सके**।
...
इस उदाहरण में Administrator से **CIFS** सेवा के लिए एक TGS का अनुरोध किया गया था, इसलिए आप **C$** तक पहुँच सकते हैं:
```bash
