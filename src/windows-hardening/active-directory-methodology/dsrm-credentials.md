...
```
Quindi dobbiamo controllare se quell'account funzionerà, e se la chiave di registro ha il valore "0" o non esiste, è necessario **impostarla su "2"**:
```bash
...
ls \\dc-host-name\C$
```
Maggiori informazioni su questo in: [https://adsecurity.org/?p=1714](https://adsecurity.org/?p=1714) e [https://adsecurity.org/?p=1785](https://adsecurity.org/?p=1785)
