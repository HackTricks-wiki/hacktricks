...
- **Kerberos ön doğrulama eksikliği**: Hedef kullanıcıların bu güvenlik özelliği etkin olmamalıdır.
- **Domain Controller (DC) ile bağlantı**: Saldırganların talepleri gönderebilmek ve şifrelenmiş mesajları alabilmek için DC'ye erişimleri olmalıdır.
