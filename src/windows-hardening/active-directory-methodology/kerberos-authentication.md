...
- **Certificate-based Kerberos changed twice**:
  ...
  - **CVE-2025-26647** added another hardening layer around `altSecurityIdentities` mappings that use a certificate's Subject Key Identifier. Patch level and explicit mapping configuration therefore matter when evaluating certificate-based paths.<sup>[[5]](#references)</sup><sup>[[6]](#references)</sup>
