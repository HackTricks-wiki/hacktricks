...
**리눅스**에서는 **sqsh**와 **mssqlclient.py**를 사용하여 MSSQL 콘솔 셸을 얻을 수 있습니다.

**윈도우**에서는 링크를 찾아 수동으로 명령을 실행할 수 있는 **MSSQL 클라이언트**인 [**HeidiSQL**](https://www.heidisql.com)을 사용할 수 있습니다.
...
### SCCM 관리 포인트 NTLM 릴레이 (OSD 비밀 추출)
SCCM **관리 포인트**의 기본 SQL 역할이 사이트 데이터베이스에서 네트워크 액세스 계정 및 작업 시퀀스 비밀을 덤프하는 데 어떻게 악용될 수 있는지 확인하십시오:
{{#ref}}
