...
हालांकि NTLM हैश इस उद्देश्य के लिए एक व्यवहार्य विधि के रूप में कार्य करता है, यह **सक्रिय सुरक्षा कारणों से Advanced Encryption Standard (AES) Kerberos कुंजियों (AES128 और AES256)** का उपयोग करके टिकटों को **जाली बनाने** की **गंभीर रूप से सिफारिश** की जाती है।
```bash:From Linux
...
रक्षा करने वाले अन्य छोटे ट्रिक्स यह कर सकते हैं कि **संवेदनशील उपयोगकर्ताओं के लिए 4769 पर अलर्ट करें** जैसे कि डिफ़ॉल्ट डोमेन प्रशासन खाता।
