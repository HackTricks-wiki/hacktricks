...
```
2. Встановіть у DC GPO `LDAP server channel binding token requirements` = **When Supported**, щоб почати збір телеметрії CBT.<sup>[[1]](#references)</sup>
...
- **3074/3075** – LDAPS binds, які завершилися б помилкою або не містили CBT (потрібен KB4520412 на 2019/2022 і наведений вище крок 2).
4. Застосовуйте примусове застосування окремими змінами:<sup>[[1]](#references)</sup>
...
- [1] [TrustedSec - LDAP Channel Binding і LDAP Signing](https://trustedsec.com/blog/ldap-channel-binding-and-ldap-signing)
- [2] [Microsoft KB4520412 - вимоги LDAP channel binding і LDAP signing](https://support.microsoft.com/en-us/topic/2020-and-2023-ldap-channel-binding-and-ldap-signing-requirements-for-windows-kb4520412-ef185fb8-00f7-167d-744c-f299a66fc00a)
- [3] [Microsoft CVE-2017-8563 - оновлення для пом'якшення LDAP relay](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8563)
- [4] [0xdf – HTB Bruno (LDAP signing вимкнено → Kerberos relay → RBCD)](https://0xdf.gitlab.io/2026/02/24/htb-bruno.html)
{{#include ../../banners/hacktricks-training.md}}
