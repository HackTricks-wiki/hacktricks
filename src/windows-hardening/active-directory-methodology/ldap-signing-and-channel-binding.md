...
```
2. Weka DC GPO `LDAP server channel binding token requirements` = **When Supported** ili kuanza telemetry ya CBT.<sup>[[1]](#references)</sup>
3. Fuatilia matukio ya Directory Service:<sup>[[1]](#references)[[2]](#references)</sup>
- **2889** – unsigned/unsigned-allow binds (signing zisizotii).
- **3074/3075** – LDAPS binds ambazo zingeshindwa au kuacha CBT (inahitajika KB4520412 kwenye 2019/2022 na hatua ya 2 hapo juu).
...
- [1] [TrustedSec - LDAP Channel Binding na LDAP Signing](https://trustedsec.com/blog/ldap-channel-binding-and-ldap-signing)
- [2] [Microsoft KB4520412 - Mahitaji ya LDAP channel binding na LDAP signing](https://support.microsoft.com/en-us/topic/2020-and-2023-ldap-channel-binding-and-ldap-signing-requirements-for-windows-kb4520412-ef185fb8-00f7-167d-744c-f299a66fc00a)
- [3] [Microsoft CVE-2017-8563 - Sasisho la mitigation ya LDAP relay](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8563)
- [4] [0xdf – HTB Bruno (LDAP signing imezimwa → Kerberos relay → RBCD)](https://0xdf.gitlab.io/2026/02/24/htb-bruno.html)
{{#include ../../banners/hacktricks-training.md}}
