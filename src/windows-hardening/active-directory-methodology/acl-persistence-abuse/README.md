...
Un privilegio similar, esto permite a los atacantes agregarse directamente a grupos modificando las propiedades del grupo si tienen el derecho de `WriteProperty` sobre esos grupos. La confirmación y ejecución de este privilegio se realizan con:
```bash
...
También puedes usar la herramienta [**GPOHound**](https://github.com/cogiceo/GPOHound) para enumerar GPOs y encontrar problemas en ellos.
