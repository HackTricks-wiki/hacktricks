...
```
2. **Помістити їх у доступну для запису спільну папку** (будь-яку папку, яку відкриває жертва):
```bash
...
```
3) Перепакуйте у .docx і доставте. Запустіть ваш SMB capture listener і зачекайте на відкриття.
