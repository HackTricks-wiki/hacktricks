...
Windows, uzak sistemlerde komut yürütmek için kullanılabilecek çeşitli mekanizmaları destekler. Aşağıdaki sayfalar, yaygın lateral-movement tekniklerini ve bunların ön koşullarını açıklar:
