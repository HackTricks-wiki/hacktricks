...
- SMB kullanarak ADMIN$'ye PSEXESVC.exe bırakmak için kullanılan klasik bir yönetici aracı, geçici bir hizmet kurar (varsayılan adı PSEXESVC) ve adlandırılmış borular üzerinden I/O'yu proxyler.
- Örnek kullanımlar:
```cmd
