...
4. Εκκίνηση της υπηρεσίας για να εκτελέσει το payload και προαιρετικά να συλλάβει stdin/stdout μέσω ενός ονομασμένου σωλήνα.
...
- Η διαδρομή δικτύου δεν βρέθηκε (53) ή δεν ήταν δυνατή η σύνδεση στο ADMIN$: το τείχος προστασίας μπλοκάρει SMB/RPC ή οι διαχειριστικές κοινές χρήσεις είναι απενεργοποιημένες.
...
- Ο χρόνος εκκίνησης της υπηρεσίας υπερβαίνει αλλά το payload εκτελέστηκε: αναμενόμενο αν δεν είναι πραγματικό δυαδικό αρχείο υπηρεσίας; καταγράψτε την έξοδο σε ένα αρχείο ή χρησιμοποιήστε smbexec για ζωντανό I/O.
