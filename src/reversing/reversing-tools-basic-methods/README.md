...
L = 256
```
Dakle, u ovom tipu programa, zanimljiv deo će biti **kako program obrađuje korisnički unos**. Na adresi **0x4000130** pronaći ćete funkciju koja se često sreće: **KEYINPUT**.
