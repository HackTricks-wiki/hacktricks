...
Z3 विशेष साइन किए गए अंकगणितीय संचालन के संस्करण प्रदान करता है जहाँ यह महत्वपूर्ण है कि **बिट-वेक्टर को साइन किया गया या असाइन किया गया माना जाए**। Z3Py में, ऑपरेटर **<, <=, >, >=, /, % और >>** **साइन किए गए** संस्करणों के अनुरूप हैं। संबंधित **असाइन किए गए** ऑपरेटर **ULT, ULE, UGT, UGE, UDiv, URem और LShR** हैं।
```python
from z3 import *
