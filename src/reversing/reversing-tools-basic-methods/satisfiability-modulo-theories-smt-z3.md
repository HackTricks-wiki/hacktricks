...
Bardzo ogólnie, to narzędzie pomoże nam znaleźć wartości dla zmiennych, które muszą spełniać pewne warunki, a obliczanie ich ręcznie byłoby bardzo uciążliwe. Dlatego możesz wskazać Z3 warunki, które zmienne muszą spełniać, a ono znajdzie jakieś wartości (jeśli to możliwe).
