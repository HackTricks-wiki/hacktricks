...
Коди взяті з [https://github.com/jakespringer/angr_ctf](https://github.com/jakespringer/angr_ctf)
...
> [!NOTE]
> Ще одне, що ви можете зробити в цих сценаріях, це **підключити функцію, надаючи angr щось, що воно може зрозуміти** легше.
