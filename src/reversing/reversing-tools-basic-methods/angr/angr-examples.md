...
>   # Για να το αναπαραστήσουμε αυτό στη μνήμη, θα θέλαμε να γράψουμε τη συμβολοσειρά στην
>   # αρχή του αρχείου:
>   #
...
> [!NOTE]
> Μερικές φορές απλές ανθρώπινες λειτουργίες όπως η σύγκριση 2 λέξεων μήκους 16 **char by char** (loop), **κοστίζουν** πολύ σε ένα **angr** επειδή χρειάζεται να δημιουργήσει διακλαδώσεις **εκθετικά** επειδή δημιουργεί 1 διακλάδωση ανά if: `2^16`\
