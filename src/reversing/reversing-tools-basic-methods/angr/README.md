...
Część tej ściągi opiera się na [dokumentacji angr](https://docs.angr.io/_/downloads/en/stable/pdf/).
...
```
# Załadowane i główne informacje o obiekcie
