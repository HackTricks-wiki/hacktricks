...
True
```
Darüber hinaus können Sie `proj.hook_symbol(name, hook)` verwenden, wobei der Name eines Symbols als erstes Argument angegeben wird, um die Adresse zu hooken, an der sich das Symbol befindet.
