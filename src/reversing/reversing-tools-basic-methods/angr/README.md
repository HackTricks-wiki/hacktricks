...
Część tego cheatsheetu bazuje na [dokumentacji angr](https://docs.angr.io/_/downloads/en/stable/pdf/).<sup>[[1]](#references)</sup>
...
```
### Symboliczne wektory bitowe i ograniczenia
```python
