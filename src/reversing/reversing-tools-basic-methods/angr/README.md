...
True
```
Además, puedes usar `proj.hook_symbol(name, hook)`, proporcionando el nombre de un símbolo como primer argumento, para hacer hook en la dirección donde se encuentra el símbolo<sup>[[1]](#references)</sup>
