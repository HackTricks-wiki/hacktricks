...
### Fundamentos ¿Qué es SCEP (Simple Certificate Enrolment Protocol)?
...
- RESTful
- sincroniza registros de dispositivos desde Apple al servidor MDM
...
Sigue unos pasos para obtener el Registro de Activación realizados por **`MCTeslaConfigurationFetcher`**. Este proceso utiliza un cifrado llamado **Absinthe**
...
- **Los certificados de anclaje** se utilizan para **evaluar la confianza** si se proporcionan.
...
- Permite **solicitudes que se fijen a certificados específicos**:
