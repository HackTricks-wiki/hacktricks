...
- Bereitgestellt über PEM-Payload
- Ermöglicht es dem Gerät, mit einem Identitätszertifikat attribuiert zu werden:
- Eigenschaft: IdentityCertificateUUID
- Bereitgestellt über SCEP-Payload

### **Schritt 7: Warten auf MDM-Befehle**

- Nachdem der MDM-Check-in abgeschlossen ist, kann der Anbieter **Push-Benachrichtigungen über APNs ausgeben**
