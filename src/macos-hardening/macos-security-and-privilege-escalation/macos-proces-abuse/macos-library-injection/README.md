...
This is like the [**LD_PRELOAD on Linux**](../../../../linux-hardening/1-linux-basics/linux-privilege-escalation/index.html#ld_preload). It allows to indicate a process that is going to be run to load a specific library from a path (if the env var is enabled)
