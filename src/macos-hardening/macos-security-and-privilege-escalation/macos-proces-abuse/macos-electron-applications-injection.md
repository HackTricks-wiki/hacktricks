...
```
Você pode carregar este arquivo em [https://hexed.it/](https://hexed.it/) e procurar a string anterior. Depois dessa string, você verá em ASCII um número "0" ou "1" indicando se cada fuse está desabilitado ou habilitado. Basta modificar o código hexadecimal (`0x30` é `0` e `0x31` é `1`) para **modificar os valores dos fuses**.
