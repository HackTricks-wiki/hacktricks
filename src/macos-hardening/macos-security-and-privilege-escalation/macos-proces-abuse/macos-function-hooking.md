...
```
> [!WARNING]
> **`DYLD_PRINT_INTERPOSTING`** ortam değişkeni, interposing'i hata ayıklamak için kullanılabilir ve interpose sürecini yazdırır.

Ayrıca, **interposing'in süreç ile yüklenen kütüphaneler arasında gerçekleştiğini** unutmayın, paylaşılan kütüphane önbelleği ile çalışmaz.
