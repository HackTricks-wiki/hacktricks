...
// यदि - अन्यथा, if झूठा लौटाता है, जबकि अन्यथा सही फ़ंक्शन को कॉल करता है और सत्य लौटाता है
<strong>            if (rax == 0x0) {
...
यह उसी फ़ंक्शन का डिकंपाइल किया गया संस्करण है जो एक अलग Hopper मुफ्त संस्करण में है:
