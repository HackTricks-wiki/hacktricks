...
- **`xpc_dictionary_get_audit_token`**이 **`xpc_connection_get_audit_token`** 대신 사용되어야 하며, 후자는 특정 상황에서 [취약할 수 있습니다](https://sector7.computest.nl/post/2023-10-xpc-audit-token-spoofing/).
