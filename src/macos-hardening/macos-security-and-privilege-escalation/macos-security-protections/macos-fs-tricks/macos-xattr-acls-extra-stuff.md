# επιπλέον στοιχεία xattr-acls στο macOS

{{#include ../../../../banners/hacktricks-training.md}}

Το παρακάτω proof of concept αναπαράγει την τεχνική AppleDouble/ACL που χρησιμοποιήθηκε στην έρευνα για το Achilles Gatekeeper bypass: σειριοποιεί ένα ACL ως extended attribute, το διατηρεί σε ένα αρχείο AppleDouble, μετονομάζει το attribute σε `com.apple.acl.text` και αναδημιουργεί το αρχείο ZIP με το `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — Achillesheel des Gatekeepers: Eine macOS-Schwachstelle aufgedeckt](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Verpacken von Mac-Software für die Distribution mit `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
