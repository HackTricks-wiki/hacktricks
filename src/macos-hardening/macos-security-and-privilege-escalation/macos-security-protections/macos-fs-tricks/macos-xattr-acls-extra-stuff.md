# Cosas adicionales sobre xattr-ACL de macOS

{{#include ../../../../banners/hacktricks-training.md}}

La siguiente prueba de concepto recrea la técnica de AppleDouble/ACL utilizada en la investigación sobre el bypass de Gatekeeper de Achilles: serializa una ACL como un atributo extendido, la conserva en un archivo AppleDouble, cambia el nombre del atributo a `com.apple.acl.text` y reconstruye el archivo ZIP con `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — El talón de Aquiles de Gatekeeper: descubriendo una vulnerabilidad de macOS](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Empaquetado de software para Mac para su distribución con `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
