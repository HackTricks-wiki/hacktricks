...
Sledeći proof of concept ponovo kreira AppleDouble/ACL tehniku korišćenu u istraživanju Achilles Gatekeeper bypass-a: serijalizuje ACL kao extended attribute, čuva ga u AppleDouble fajlu, preimenuje atribut u `com.apple.acl.text` i ponovo kreira ZIP arhivu pomoću `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — Ahilova peta Gatekeeper-a: Otkrivanje ranjivosti u macOS-u](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Pakovanje Mac softvera za distribuciju pomoću `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
