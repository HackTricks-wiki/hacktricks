# Додаткові матеріали щодо xattr-ACL у macOS

{{#include ../../../../banners/hacktricks-training.md}}

Наведений proof of concept відтворює техніку AppleDouble/ACL, використану в дослідженні обходу Gatekeeper від Achilles: він серіалізує ACL як extended attribute, зберігає його у файлі AppleDouble, перейменовує атрибут на `com.apple.acl.text` і перебудовує ZIP-архів за допомогою `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — Ахіллесова п'ята Gatekeeper: виявлення вразливості macOS](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Пакування програмного забезпечення для Mac для розповсюдження за допомогою `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
