...
Il seguente proof of concept ricrea la tecnica AppleDouble/ACL utilizzata nella ricerca sul bypass di Achilles Gatekeeper: serializza un ACL come extended attribute, lo conserva in un file AppleDouble, rinomina l'attributo in `com.apple.acl.text` e ricostruisce l'archivio ZIP con `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — Il tallone d'Achille di Gatekeeper: scoprire una vulnerabilità di macOS](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Preparare il software Mac per la distribuzione con `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
