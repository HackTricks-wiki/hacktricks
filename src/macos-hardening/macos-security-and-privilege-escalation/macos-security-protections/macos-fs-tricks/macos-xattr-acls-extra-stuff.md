# Dodatkowe informacje o xattr-ACL w macOS

{{#include ../../../../banners/hacktricks-training.md}}

Poniższy proof of concept odtwarza technikę AppleDouble/ACL wykorzystaną w badaniach nad obejściem Gatekeepera Achilles: serializuje ACL jako extended attribute, zachowuje je w pliku AppleDouble, zmienia nazwę atrybutu na `com.apple.acl.text`, a następnie przebudowuje archiwum ZIP za pomocą `ditto`.<sup>[[1]](#references)[[2]](#references)</sup>
```bash
rm -rf /tmp/test*
echo test >/tmp/test
...
- [1] [Microsoft Security Blog — Odkrywanie podatności macOS: pięta achillesowa Gatekeepera](https://www.microsoft.com/en-us/security/blog/2022/12/19/gatekeepers-achilles-heel-unearthing-a-macos-vulnerability/)
- [2] [Apple Developer — Pakowanie oprogramowania Mac do dystrybucji za pomocą `ditto`](https://developer.apple.com/documentation/xcode/packaging-mac-software-for-distribution)
{{#include ../../../../banners/hacktricks-training.md}}
