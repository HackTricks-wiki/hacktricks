...
Keychain items hupangwa katika **access groups**. Entitlement ya `keychain-access-groups` ya application huorodhesha groups ambazo inaweza kufikia:
```xml
