...
sfltool resettbtm
```
- **Stop die Agent**: Dit is moontlik om ’n stopsein na die agent te stuur sodat dit **nie die gebruiker sal waarsku** wanneer nuwe bespeurings gevind word nie.<sup>[[1]](#references)</sup>
```bash
# Get PID
