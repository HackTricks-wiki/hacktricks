...
- [**Little Snitch**](https://www.obdev.at/products/littlesnitch/index.html): यह प्रत्येक process द्वारा बनाए गए हर connection को monitor करेगा। mode (silent allow connections, silent deny connection और alert) के आधार पर, हर बार नया connection stablished होने पर यह **आपको एक alert दिखाएगा**। इसमें यह सारी information देखने के लिए एक बहुत अच्छा GUI भी है।
...
- [**BlockBlock**](https://objective-see.org/products/blockblock.html): KnockKnock की तरह, लेकिन persistence generate करने वाले processes को monitor करके।
...
```
यदि `systemextensionsctl list` किसी sensor को **`[activated enabled]`** दिखाता है, तो यह आमतौर पर सबसे तेज़ संकेत होता है कि extension वास्तव में live है। **macOS 15 Sequoia और बाद के संस्करणों** पर MDM विशिष्ट security extensions को **UI से non-removable** के रूप में भी चिह्नित कर सकता है, इसलिए "System Settings से इसे disable करें" अब सुरक्षित धारणा नहीं है। Internals के लिए [macOS System Extensions](mac-os-architecture/macos-system-extensions.md) देखें।

## Recent native telemetry जिसे defenders consume कर सकते हैं

Recent macOS releases ने पहले detect करने में परेशान करने वाले कुछ user-driven bypasses को blue teams के लिए अधिक noisy बना दिया है:
...
- **macOS 15.4+**: Endpoint Security में **`tcc_modify`** जोड़ा गया है, जो defenders को TCC debug logs scrape करने के बजाय **TCC grants/revokes** monitor करने का supported तरीका देता है।<sup>[1]</sup>
```bash
...
```
यह defenders और self-assessment करने वाले red teamers—दोनों के लिए उपयोगी है: यदि target में mature ES-based stack है, तो **user-approved Gatekeeper / TCC bypass chains may be much more visible than they used to be**। इन protections की background जानकारी के लिए [Gatekeeper / Quarantine / XProtect](macos-security-protections/macos-gatekeeper.md) और [TCC](macos-security-protections/macos-tcc/README.md) देखें।
