...
### Sections μνήμης που χρησιμοποιούνται

Τα περισσότερα δεδομένα που χρησιμοποιούνται από το Objective‑C runtime αλλάζουν κατά την εκτέλεση, επομένως χρησιμοποιεί αρκετές sections από την οικογένεια segments `__DATA` του Mach‑O στη μνήμη. Ιστορικά, αυτές περιλάμβαναν:
