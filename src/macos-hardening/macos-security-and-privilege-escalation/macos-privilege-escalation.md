...
{{#ref}}
../../linux-hardening/1-linux-basics/linux-privilege-escalation
{{#endref}}
...
You can find the original [Sudo Hijacking technique inside the Linux Privilege Escalation post](../../linux-hardening/1-linux-basics/linux-privilege-escalation/index.html#sudo-hijacking).
