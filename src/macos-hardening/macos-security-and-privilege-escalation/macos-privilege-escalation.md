...
일부 **소셜 엔지니어링**을 사용하여 Dock에서 **예를 들어 Google Chrome**을 **사칭**하고 실제로 자신의 스크립트를 실행할 수 있습니다:

{{#tabs}}
{{#tab name="Chrome Impersonation"}}
몇 가지 제안:

- Dock에서 Chrome이 있는지 확인하고, 그런 경우 **해당 항목을 제거**하고 Dock 배열의 **같은 위치에 가짜 Chrome 항목을 추가**하세요.
```bash
#!/bin/sh
