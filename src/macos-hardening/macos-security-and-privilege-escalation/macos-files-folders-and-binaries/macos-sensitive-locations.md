...
शैडो पासवर्ड उपयोगकर्ता की कॉन्फ़िगरेशन के साथ **`/var/db/dslocal/nodes/Default/users/`** में स्थित प्लिस्ट में संग्रहीत होता है।\
...
```
एक और तरीका `ShadowHashData` प्राप्त करने का है `dscl` का उपयोग करके: `` sudo dscl . -read /Users/`whoami` ShadowHashData ``
...
```
#### **कीचेन कुंजियों (पासवर्ड के साथ) को डंप करना हैश को क्रैक करके**
```bash
...
पासवर्ड फ़ाइल **`/etc/kcpassword`** में **`0x7D 0x89 0x52 0x23 0xD2 0xBC 0xDD 0xEA 0xA3 0xB9 0x1F`** कुंजी के साथ xored किया गया है। यदि उपयोगकर्ता का पासवर्ड कुंजी से लंबा है, तो कुंजी का पुन: उपयोग किया जाएगा।\
...
सबसे दिलचस्प जानकारी **blob** में होगी। इसलिए आपको उस सामग्री को **extract** करना होगा और **transform** करना होगा ताकि यह **human** **readable** हो या **`strings`** का उपयोग करें। इसे एक्सेस करने के लिए आप कर सकते हैं:
```bash
