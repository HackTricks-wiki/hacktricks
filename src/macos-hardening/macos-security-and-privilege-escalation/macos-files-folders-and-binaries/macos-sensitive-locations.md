...
Ovaj fajl se **koristi samo** kada sistem radi u **single-user mode** (dakle, ne naročito često).
...
```
#### **Dump keychain ključeva (sa lozinkama) cracking hash-a**
```bash
