...
- Проведіть зверху, щоб зробити заголовок видимим для програми, відкритої в повноекранному режимі;
...
| ↑↓ (Вгору стрілка, Вниз стрілка)                          | Одночасно натискайте вибраний елемент                        |
