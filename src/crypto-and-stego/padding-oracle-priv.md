...
## Nachrichtenausfüllung

Da die Verschlüsselung in **festen** **Größen** **Blöcken** durchgeführt wird, ist in dem **letzten** **Block** normalerweise eine **Auffüllung** erforderlich, um seine Länge zu vervollständigen.\
In der Regel wird **PKCS7** verwendet, das eine Auffüllung **erzeugt**, die die **Anzahl** der **benötigten** **Bytes** **wiederholt**, um den Block zu vervollständigen. Wenn der letzte Block beispielsweise 3 Bytes fehlt, wird die Auffüllung `\x03\x03\x03` sein.
...
Beachten Sie, dass im letzten Beispiel der **letzte Block voll war, sodass ein weiterer nur mit Auffüllung generiert wurde**.

## Padding Oracle

Wenn eine Anwendung verschlüsselte Daten entschlüsselt, wird sie zuerst die Daten entschlüsseln; dann wird sie die Auffüllung entfernen. Während der Bereinigung der Auffüllung, wenn eine **ungültige Auffüllung ein erkennbares Verhalten auslöst**, haben Sie eine **Padding-Oracle-Schwachstelle**. Das erkennbare Verhalten kann ein **Fehler**, ein **Mangel an Ergebnissen** oder eine **langsamere Antwort** sein.
...
Um den **letzten** **Block** (**E8** bis **E15**) zu **entschlüsseln**, durchläuft der gesamte Block die "Blockchiffrierentschlüsselung", die die **Zwischenbytes I0 bis I15** erzeugt.\
