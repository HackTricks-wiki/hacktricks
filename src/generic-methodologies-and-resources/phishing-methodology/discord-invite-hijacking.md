...
- Use permanent invite links containing at least one uppercase letter or non-alphanumeric character (never expire, non-reusable).<sup>[[1]](#references)</sup>
...
- [2] [Discord Custom Invite Link Documentation](https://support.discord.com/hc/en-us/articles/115001542132-Custom-Invite-Link)
