...
können Sie das Tool [**ctf-usb-keyboard-parser**](https://github.com/TeamRocketIst/ctf-usb-keyboard-parser) verwenden, um zu erfahren, was in der Kommunikation geschrieben wurde:
```bash
