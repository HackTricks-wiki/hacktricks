...
在 **Windows** 上，您可以尝试使用 Arsenal Image Mounter 的免费版本 ([https://arsenalrecon.com/downloads/](https://arsenalrecon.com/downloads/)) 来 **挂载取证镜像**。
...
```
请注意扇区大小为 **512**，起始为 **2048**。然后像这样挂载镜像：
```bash
