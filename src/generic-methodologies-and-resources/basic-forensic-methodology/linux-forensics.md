...
sshd_config ve sistem hesap kabuklarındaki değişiklikler, erişimi korumak için yaygın olarak post‑exploitation sırasında yapılır.
```bash
...
- **MySQL**: Yetkisiz veritabanı etkinliklerini açığa çıkarabilecek yürütülen MySQL sorguları için _\~/.mysql_history_ dosyasını araştırın.
