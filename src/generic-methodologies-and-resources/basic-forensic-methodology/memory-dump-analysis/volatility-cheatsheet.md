...
```
As jy iets **vinnig en mal** wil hê wat verskeie Volatility-plugins parallel sal uitvoer, kan jy gebruik: [https://github.com/carlospolop/autoVolatility](https://github.com/carlospolop/autoVolatility)
```bash
