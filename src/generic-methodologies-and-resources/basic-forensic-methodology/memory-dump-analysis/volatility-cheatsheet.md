...
È possibile **leggere dalla memoria la cronologia di bash.** Potresti anche eseguire il dump del file _.bash_history_, ma è stato disabilitato, sarai felice di poter utilizzare questo modulo di volatilità.
