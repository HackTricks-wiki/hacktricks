...
- **Dados de formulários**: Informações inseridas em formulários da web, salvas para futuras sugestões de preenchimento automático.
...
O Google Chrome armazena perfis de usuário em locais específicos com base no sistema operacional:<sup>[[1]](#references)</sup>
...
- **Favicons**: Armazena os favicons dos sites.
...
- **Extensions**: Diretórios para extensões e addons do navegador.
...
Os metadados de downloads podem ser acessados por meio do [ESEDatabaseView](https://www.nirsoft.net/utils/ese_database_view.html), com contêineres específicos contendo dados como URL, tipo de arquivo e local do download. Os arquivos físicos podem ser encontrados em `%userprofile%\Appdata\Roaming\Microsoft\Windows\IEDownloadHistory`.
...
Os dados do Opera ficam em `/Users/$USER/Library/Application Support/com.operasoftware.Opera` e compartilham o formato do Chrome para histórico e downloads.
