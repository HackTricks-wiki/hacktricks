...
`myset.pop()` --> λαμβάνει ένα αυθαίρετο στοιχείο και το αφαιρεί\
...
```
**batched**\
`from itertools import batched` --> διαθέσιμο σε Python 3.12+, χρήσιμο για την κατάτμηση μεγάλων λιστών υποψηφίων bruteforce ή αρχείων IOC
```python
