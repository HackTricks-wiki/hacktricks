...
- [2] [Package : python3-venv — Paquets Ubuntu](https://packages.ubuntu.com/noble/python/python3-venv)
- [3] [wheel 0.24.0 — PyPI](https://pypi.org/project/wheel/0.24.0/)
- [4] [wheel — PyPI](https://pypi.org/project/wheel/)
- [5] [setup.py est-il obsolète ? — Guide de l’utilisateur du packaging Python](https://packaging.python.org/en/latest/discussions/setup-py-deprecated/)
