...
```
Paketi ters shell oluşturmak için buradan indirebilirsiniz. Lütfen, kullanmadan önce **sıkıştırmayı açın, `setup.py` dosyasını değiştirin ve ters shell için IP'nizi girin**:
