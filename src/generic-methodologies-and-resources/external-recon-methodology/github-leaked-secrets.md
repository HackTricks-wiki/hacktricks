...
```
- Gitleaks em todos os repositórios da org (clone shallow and scan):
```bash
...
```
> Dica: Para o histórico do git, prefira scanners que analisem `git log -p --all` para capturar secrets removidos.
