...
도메인의 **새 서브도메인**이 생성되는지 **모니터링**할 수 있습니다. **Certificate Transparency** 로그를 모니터링하는 [**sublert**](https://github.com/yassineaboukir/sublert/blob/master/sublert.py)가 있습니다.
...
**웹** 서버와 관련된 **열려 있는 포트를 발견하는 빠른 방법**은 [**masscan**를 여기에서 찾을 수 있습니다](../pentesting-network/index.html#http-port-discovery).\
