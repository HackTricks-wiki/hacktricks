...
**Pesquise no google** por credenciais padrão da tecnologia que está sendo utilizada, ou **tente estes links**:
...
Verifique isso antes de tentar forçar um Hash. 
...
```
Quebrando Hashes Comuns de Aplicação
```
900 | MD4                                              | Raw Hash
0 | MD5                                              | Raw Hash
