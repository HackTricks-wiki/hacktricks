...
- [4] [ShellPop - master のように shell を pop する](https://github.com/0x00-0x00/ShellPop)
- [5] [ShellReverse - python、perl、ruby、bash、netcat、php、java、powershell などの Shell reverse creator](https://github.com/cybervaca/ShellReverse)
...
- [9] [revshellgen - Python 3 で書かれた Reverse shell generator](https://github.com/t0thkr1s/revshellgen)
