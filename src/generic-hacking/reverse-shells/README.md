...
- [9] [revshellgen - Générateur de reverse shell écrit en Python 3](https://github.com/t0thkr1s/revshellgen)
- [10] [rsg (ReverShellGenerator) - Outil pour générer différentes méthodes de reverse shell](https://github.com/mthbernardes/rsg)
