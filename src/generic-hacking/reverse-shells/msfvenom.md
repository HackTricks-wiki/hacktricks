...
Usa `-a` per selezionare l'architettura del payload e `--platform` per selezionare la piattaforma target.<sup>[[1]](#references)</sup>
...
```
## **Payload in linguaggio di scripting**
