...
Ako žrtva ima SSH, napadač može montirati direktorijum sa žrtvinog sistema na svoj.
```bash
...
goshs -smtp -smtp-domain [REDACTED]
```
Primljeni imejlovi i callback-ovi prikazuju se direktno u izlazu terminala.  
