...
1. **Initialization**: Chagua K vitu vya mwanzo vya kundi (centroids), mara nyingi kwa bahati nasibu au kupitia mbinu bora kama k-means++
...
Tutatumia seti ya data ya mtihani ya awali (ambayo ina pointi za kawaida na baadhi ya mashambulizi) na kuendesha Isolation Forest ili kuona kama inaweza kutenga mashambulizi. Tutadhani tunatarajia ~15% ya data kuwa ya anomali (kwa maonyesho).
```python
