...
- **Auto-Attenzione Multi-Head:** Consente al modello di concentrarsi su diverse posizioni all'interno della sequenza di input durante la codifica di un token.
- **Componenti chiave:**
...
- **Proiezione di output:** Livello lineare per combinare le uscite di tutte le teste.
