...
LLM architecture example from [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb):<sup>[[1]](#references)</sup>
...
Let's explain it step by step:<sup>[[2]](#references)</sup>
...
Having the GPT structure defined it's possible to find out the number of parameters to train:<sup>[[1]](#references)</sup>
