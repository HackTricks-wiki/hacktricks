...
Usually a LLM is characterised for the configuration used to train it. This are the common components when training a LLM:<sup>[[1]](#references)[[2]](#references)</sup>
