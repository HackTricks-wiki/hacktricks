...
* [Write-up factory](https://writeup.raw.pm/) - Write-upsを見つけるための検索エンジン（TryHackMe、HackTheBoxなど）
* [CTFtime Write-ups](https://ctftime.org/writeups) - CTFイベントに追加された最新のWrite-ups
