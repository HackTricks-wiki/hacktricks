...
If you want to **share some tricks with the community** you can also submit **pull requests** to [**Carlospolop's Github**](https://github.com/carlospolop/hacktricks) **that will be reflected in this book.  
