...
Tool to enumerate GCP externally: [https://github.com/initstring/cloud_enum/blob/master/enum_tools/gcp_checks.py](https://github.com/initstring/cloud_enum/blob/master/enum_tools/gcp_checks.py), [https://github.com/0xsha/CloudBrute](https://github.com/0xsha/CloudBrute), [https://github.com/jordanpotti/CloudScraper](https://github.com/jordanpotti/CloudScraper)
...
### Local privilege escalation <a href="local-privilege-escalation" id="local-privilege-escalation"></a>
...
#### Follow the scripts! <a href="follow-the-scripts" id="follow-the-scripts"></a>
...
#### SSH'ing around <a href="sshing-around" id="sshing-around"></a>
...
#### Abusing networked services <a href="abusing-networked-services" id="abusing-networked-services"></a>
...
#### Organization-level IAM permissions <a href="organization-level-iam-permissions" id="organization-level-iam-permissions"></a>
...
#### Exploring other projects <a href="exploring-other-projects" id="exploring-other-projects"></a>
...
### Treasure hunting <a href="treasure-hunting" id="treasure-hunting"></a>
...
#### Accessing databases <a href="accessing-databases" id="accessing-databases"></a>
...
#### Enumerating storage buckets <a href="enumerating-storage-buckets" id="enumerating-storage-buckets"></a>
...
#### Decrypting secrets with crypto keys <a href="decrypting-secrets-with-crypto-keys" id="decrypting-secrets-with-crypto-keys"></a>
...
#### Querying custom metadata <a href="querying-custom-metadata" id="querying-custom-metadata"></a>
...
#### Reviewing serial console logs <a href="reviewing-serial-console-logs" id="reviewing-serial-console-logs"></a>
...
#### Reviewing custom images <a href="reviewing-custom-images" id="reviewing-custom-images"></a>
...
#### Reviewing Custom Instance Templates <a href="reviewing-custom-instance-templates" id="reviewing-custom-instance-templates"></a>
...
#### Reviewing Stackdriver logging <a href="reviewing-stackdriver-logging" id="reviewing-stackdriver-logging"></a>
...
#### Reviewing cloud functions <a href="reviewing-cloud-functions" id="reviewing-cloud-functions"></a>
...
#### Reviewing app engine configurations <a href="reviewing-app-engine-configurations" id="reviewing-app-engine-configurations"></a>
...
#### Reviewing cloud run configurations <a href="reviewing-cloud-run-configurations" id="reviewing-cloud-run-configurations"></a>
...
#### Reviewing AI platform configurations <a href="reviewing-ai-platform-configurations" id="reviewing-ai-platform-configurations"></a>
...
#### Reviewing cloud pub/sub <a href="reviewing-cloud-pubsub" id="reviewing-cloud-pubsub"></a>
...
#### Reviewing cloud Git repositories <a href="reviewing-cloud-git-repositories" id="reviewing-cloud-git-repositories"></a>
...
#### Reviewing cloud filestore instances <a href="reviewing-cloud-filestore-instances" id="reviewing-cloud-filestore-instances"></a>
...
#### Taking a crack at Kubernetes <a href="taking-a-crack-at-kubernetes" id="taking-a-crack-at-kubernetes"></a>
...
#### Reviewing secrets management <a href="reviewing-secrets-management" id="reviewing-secrets-management"></a>
...
#### Searching the local system for secrets <a href="searching-the-local-system-for-secrets" id="searching-the-local-system-for-secrets"></a>
...
#### Automating Enumeration <a href="automating-enumeration" id="automating-enumeration"></a>
