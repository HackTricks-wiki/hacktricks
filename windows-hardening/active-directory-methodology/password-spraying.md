...
```
* [_**spray**_](https://github.com/Greenwolf/Spray) _**(puedes indicar el número de intentos para evitar bloqueos):**_
```bash
...
Existen múltiples herramientas para realizar ataques de p**assword spraying** en Outlook.
...
Para utilizar cualquiera de estas herramientas, se necesita una lista de usuarios y una contraseña / una pequeña lista de contraseñas para realizar el ataque.
```bash
