...
Este tipo de ataque es similar a Pasar la Clave, pero en lugar de usar hashes para solicitar un ticket, el ticket en sí es robado y utilizado para autenticarse como su propietario.
...
```
[Kekeo](https://github.com/gentilkiwi/kekeo), para convertirlos en Windows. Esta herramienta no fue verificada debido a que requiere una licencia en su biblioteca ASN1, pero creo que vale la pena mencionarla.
...
* [https://www.tarlogic.com/blog/como-atacar-kerberos/](https://www.tarlogic.com/blog/como-atacar-kerberos/)

<figure><img src="../../.gitbook/assets/image (3) (1) (1).png" alt=""><figcaption></figcaption></figure>

\
Utiliza [**Trickest**](https://trickest.com/?utm\_campaign=hacktrics\&utm\_medium=banner\&utm\_source=hacktricks) para construir y **automatizar flujos de trabajo** con las herramientas de comunidad más avanzadas del mundo.\
Obtén acceso hoy mismo:
