...
```
{% hint style="warning" %}
La contraseña aún se restablecerá si un **administrador** utiliza el cmdlet **`Reset-AdmPwdPassword`**; o si está habilitada la opción **No permitir que el tiempo de expiración de la contraseña sea más largo de lo requerido por la política** en la GPO de LAPS.
{% endhint %}
