...
```
{% hint style="warning" %}
La contraseña aún se restablecerá si un **administrador** utiliza el cmdlet **`Reset-AdmPwdPassword`**; o si **No permitir un tiempo de expiración de contraseña más largo de lo requerido por la directiva** está habilitado en la directiva de LAPS.
{% endhint %}
