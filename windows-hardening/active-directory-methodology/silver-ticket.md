...
コンピューター上でのwinrmアクセスを使用すると、**それにアクセス**し、PowerShellを取得することができます。
```bash
New-PSSession -Name PSC -ComputerName the.computer.name; Enter-PSSession PSC
```
以下のページをチェックして、**winrmを使用してリモートホストに接続する他の方法**を学びましょう：
