...
```
Esto es útil si tienes credenciales válidas para acceder a objetos en la red pero esas credenciales no son válidas dentro del host actual ya que solo se usarán en la red (en el host actual se usarán los privilegios de tu usuario actual).
