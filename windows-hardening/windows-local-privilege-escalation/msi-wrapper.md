...
Ten en cuenta que puedes envolver un "**.bat**" si **solo** deseas **ejecutar** **líneas de comandos (en lugar de cmd.exe selecciona el archivo .bat)**
...
Desde aquí, simplemente haz clic en los **botones de siguiente** y el último **botón de construir y se generará tu instalador/envoltura**.
