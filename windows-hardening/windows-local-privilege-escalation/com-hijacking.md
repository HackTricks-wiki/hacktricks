...
Depois de decidir qual COM inexistente se passar, execute os seguintes comandos. _Tenha cuidado se decidir se passar por um COM que é carregado a cada poucos segundos, pois isso pode ser excessivo._&#x20;
```bash
...
# [mais saídas como a anterior...]</code></pre>
