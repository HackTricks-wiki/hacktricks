...
Cuando UAC está en su lugar, a un usuario administrador se le otorgan 2 tokens: una clave de usuario estándar, para realizar acciones regulares como nivel regular, y otra con los privilegios de administrador.
...
Entonces, debes revisar el valor de **`LocalAccountTokenFilterPolicy`**\
...
Es importante mencionar que es **mucho más difícil evitar el UAC si está en el nivel de seguridad más alto (Siempre) que si está en cualquiera de los otros niveles (Predeterminado).**
...
10     0      14393  0
```
Además, utilizando [esta](https://en.wikipedia.org/wiki/Windows\_10\_version\_history) página obtienes la versión de Windows `1607` a partir de las versiones de compilación.
