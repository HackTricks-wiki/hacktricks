...
Si te encuentras con una **vulnerabilidad de RCE** dentro de una aplicación web basada en Linux, puede haber casos en los que **obtener un shell inverso se vuelva difícil** debido a la presencia de reglas de Iptables u otros filtros. En tales escenarios, considera crear un shell PTY dentro del sistema comprometido usando tuberías.
