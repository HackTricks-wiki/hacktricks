...
Conexión por enlace, Shell inverso (TCP, UDP, DNS), Redirección de puerto, Subir/bajar archivos, Generar payloads, Servir archivos...
```
Serve a cmd Shell:
