...
EWF (Expert Witness Format) is a file format that is commonly used in digital forensics to store disk images. EWF files can contain both the physical and logical disk images, as well as metadata related to the acquisition process. EWF files are often used in forensic investigations to ensure the integrity and authenticity of the acquired data.
```bash
#Get file type
file evidence.E01
