...
```
{% tab title="fork" %}
Este ejemplo utiliza un **`fork`** para lanzar **procesos hijos que aprovecharán la condición de carrera del PID** y luego aprovecharán **otra condición de carrera a través de un enlace duro:**
```objectivec
