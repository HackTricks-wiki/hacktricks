...
En esta página puedes encontrar cómo crear una aplicación para lanzar comandos arbitrarios desde dentro de la sandbox predeterminada de macOS:
...
4. Firma la app (necesitas crear un certificado en el llavero)
```bash
