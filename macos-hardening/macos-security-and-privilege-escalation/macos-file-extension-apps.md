# Manipuladores de aplicativos de esquema de URL e extensão de arquivo do macOS
...
A seguinte linha pode ser útil para encontrar os aplicativos que podem abrir arquivos dependendo da extensão:
```
